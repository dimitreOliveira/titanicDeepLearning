...
# num_epochs = 2752
# trained_parameters, submission_name = model(train_pre, train_labels, layers_dims, train_size=train_size,
#                                             num_epochs=num_epochs, learning_rate=learning_rate, use_l2=True, l2_beta=0.0015,
#                                             print_cost=False, print_accuracy=False, plot_cost=False, use_dropout=True, keep_prob=0.8)
# print(submission_name)
#
